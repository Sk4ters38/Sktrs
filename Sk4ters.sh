...
echo
echo "$white                       ##########################"
echo "$white                       ##    Author : Sk4ters  ##"
echo "$white                       ##    Versi  : 1.0      ##"
echo "$white                       ##########################"
echo
echo                        
echo "$red                                Tool Termux"
echo "$white                            ISLAMIC CYBER TEAM"
echo "$white                        From cyber to brothers"
echo
echo "$white
        ********************Silahkan Pilih***************************
        |===========================================================|
        |#####MetasploitUser##### |#####PhishingTools#####          |
        |=========================|==============================   |
        |1.  Install Metasploit   | 5.  Install Weeman              |
        |2.  Install Tmux-Bunch   | 6.  Install Blackeye            |
        |3.  Install Ngrok        | 7.  Install SocialFish (Root)   |
        |4.  Install Shodan       |                                 |
        |=========================|===============================  |
        |#####SosmedTools#####    | #####UsersBOT#####              |
        |8.  Install BlackHydra   | 14. Install Instabot            |
        |9.  Install Cupp         | 14. Install Instabot            |
        |10. Install MBF          | 15. Install Bot Komen Fb        |
        |11. Install Instahack    | 16. Install Bot Like Fb         |
        |12. Install Twiter Sniper| 17. Install Chuckyfix           |
        |13. Install Hacktronian  |                                 |
        |=========================|================================ |
        |#####Defacer#####        | ########OTHERS########          |
        |=========================|================================ |
        |18. Install Sqlmap       | 24. Install Java                |
        |19. Install LFISuite     | 25. Install Fedora              |
        |20. Install Bingoo       | 26. Install Nethunter           |
        |21. Install LiteScript   | 27. Install Debian              |
        |22. Install XAttacker    | 28. Install Ubuntu              |
        |23. Install Diejoubu     | 29. Install Kali Linux          |
        |===========================================================|
        |                                                           |
        |              ======Special Tools======                    |
        ...
        |                       thanks To:                          |
        |===========================================================|
        |-MR.057   |  -Islamic Cyber Team        |-All member LCT   |
        |_MR.SDV   |  -Cyber Indo Community    |-All member BUFT    | ""
        |===========================================================|
        ---------------------------######----------------------------"| lolcat
trap ctrl_c INT
ctrl_c() {
